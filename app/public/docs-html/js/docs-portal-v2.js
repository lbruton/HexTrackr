...
class DocumentationPortalV2 {
    ...
    async loadNavigationStructure() {
        ...
        try {
            ...
            console.warn("Could not auto-discover structure, using fallback:", error);
    ...
    async discoverDocumentationStructure() {
        try {
            ...
            console.warn("Falling back to basic structure discovery...");
    ...
    async discoverRoadmapsStructure(structure) {
        ...
        try {
            ...
            console.warn("Could not discover roadmaps structure:", error);
        }
    }
    ...
    async discoverFilesInSection(section, children) {
        ...
        try {
            ...
            if (response.ok) {
                ...
                console.log(` Directory listing failed (${response.status}), falling back to pattern testing`);
