...
export function validateWCAGCompliance(ratio, level = "AA", textSize = "normal") {
    try {
        ...
        const requiredRatio = textSize === "large" ? standards.LARGE_TEXT : standards.NORMAL_TEXT;
...
export function validateColorCombination(foreground, background, options = {}) {
    const { level = "AA", includeAAA = false, textSizes = ["normal", "large"], label = "Color combination" } = options;
