...
import { validateColorCombination, batchValidateColors, WCAG_STANDARDS } from "./wcag-contrast-validator.js";
...
const CRITICAL_COMBINATIONS = [
    ...
    {
        fg: DARK_THEME_COLORS.bodyColor,
        bg: DARK_THEME_COLORS.bodyBg,
        label: "Body text on page background",
        critical: true,
    },
    {
        fg: DARK_THEME_COLORS.emphasisColor,
        bg: DARK_THEME_COLORS.bodyBg,
        label: "Emphasis text on page background",
        critical: true,
    },
    {
        fg: DARK_THEME_COLORS.secondaryColor,
        bg: DARK_THEME_COLORS.bodyBg,
        label: "Secondary text on page background",
        critical: false,
    },
    {
        fg: DARK_THEME_COLORS.tertiaryColor,
        bg: DARK_THEME_COLORS.bodyBg,
        label: "Tertiary text on page background",
        critical: false,
    },
    ...
    },
    {
        fg: DARK_THEME_COLORS.emphasisColor,
        bg: DARK_THEME_COLORS.cardBg,
        label: "Emphasis text on card background",
        critical: true,
    },

    // Navigation combinations
    {
        fg: DARK_THEME_COLORS.navbarBrand,
        bg: DARK_THEME_COLORS.navbarBg,
        label: "Brand text in navigation",
        critical: true,
    },
    { fg: DARK_THEME_COLORS.navbarLink, bg: DARK_THEME_COLORS.navbarBg, label: "Navigation links", critical: true },
    {
        fg: DARK_THEME_COLORS.navbarLinkHover,
        bg: DARK_THEME_COLORS.navbarBg,
    ...
    // Form combinations
    {
        fg: DARK_THEME_COLORS.formControlColor,
        bg: DARK_THEME_COLORS.formControlBg,
