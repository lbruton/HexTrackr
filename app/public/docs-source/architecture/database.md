...
erDiagram
    ...
    %% Cisco Fixed Versions Normalization
    cisco_advisories ||--o{ cisco_fixed_versions : "normalized_versions"
    ...
    audit_log_config {
        ...
        DATETIME key_rotated_at
        INTEGER retention_days
        DATETIME last_cleanup_at
        INTEGER total_logs_written
        INTEGER total_logs_purged
        DATETIME created_at
        DATETIME updated_at
    }
