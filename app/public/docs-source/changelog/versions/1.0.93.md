...
const vprSeverity = vprScore >= 9 ? "critical" : vprScore >= 7 ? "high" : vprScore >= 4 ? "medium" : "low";
const vprColor = vprScore >= 9 ? "red" : vprScore >= 7 ? "orange" : vprScore >= 4 ? "blue" : "green";
...
_Changelog Version: 1.0.93 | Release Date: 2025-10-21_
