...
- ✅ Audit trail preserved for compliance (tickets never truly deleted)
- ✅ XT# uniqueness guaranteed for database lifetime (no number reuse)
- ✅ Accidental deletes recoverable (future admin UI can restore)
- ✅ ServiceNow references remain valid (foreign key integrity)
