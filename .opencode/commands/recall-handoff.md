...
- `"handoff spec:001"` - All handoffs for specification 001
- `"handoff blocked"` - Handoffs with blocking issues
- `"handoff project:hextrackr in-progress"` - Active HexTrackr handoffs
- `"handoff week-38-2025"` - This week's handoffs
- `"handoff backend spec:022"` - Backend handoffs for spec 022
