# HexTrackr Project Guide for OpenAI Codex

Project-specific guidance for HexTrackr vulnerability management system when using OpenAI Codex.

## Your Role: Maintenance & Cleanup (1-2 hours)

You handle maintenance and standardization tasks:

- Code style standardization and formatting
- Dependency updates and security patches
- Test coverage improvements and documentation generation
- Cleanup and optimization of existing code
...
2. Review maintenance priorities and cleanup targets
3. Understand what areas need standardization

**At Session End**:

1. Update `/dev-docs/session-handoff.json` with cleanup progress
2. Document any patterns standardized or issues resolved
3. Note remaining maintenance tasks
...
- Use sequential loops for row iteration to prevent race conditions
- Store complex data as JSON strings with proper parsing/validation

### Code Quality Goals

- **Target**: <50 total Codacy issues
