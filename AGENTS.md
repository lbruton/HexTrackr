...
HexTrackr follows a modular architecture where:
- `app/public/server.js` bootstraps the Express instance, wiring routers, sockets, and middleware from `app/`
...
- `docs/` and `app/public/docs-html/` contain generated documentation; `planning/` and `memento/` capture roadmap material
