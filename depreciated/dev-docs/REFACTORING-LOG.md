...
### 🚨 CRITICAL: Project Structure Refactor Required

**Priority:** CRITICAL - Must complete BEFORE continuing modularization  
**Issue Identified:** September 8, 2025

#### Problem Analysis

- **39 Root Directory Items**: Project has become unwieldy with excessive root-level files
- **Docker Container Conflicts**: Accidental Node.js direct startups cause container conflicts
- **Path Reference Dependencies**: 20+ HTML files have hardcoded relative paths that break with restructure
- **Development vs App Code**: No clean separation between application code and development tools

#### Solution Strategy: /app Folder Migration

**Target Structure:**
```
/
├── app/
│   └── public/          # All application code (HTML, CSS, JS, server.js)
├── dev-docs/           # Development documentation
├── __tests__/          # Test infrastructure  
├── docker-compose.yml  # Container configuration
└── <10 other items     # Minimal root directory
```

#### Implementation Requirements

1. **Move Application Code**: HTML, CSS, JS, server.js → `/app/public/`
2. **Update Docker Paths**: Modify docker-compose.yml for new app structure  
3. **Fix HTML References**: Update 20+ relative path references
4. **Container Isolation**: Ensure only Docker can start Node.js server
5. **Git Submodule Ready**: Structure for clean public repo + dev backup

#### Success Criteria

- ✅ Root directory <10 items for clean navigation
- ✅ Zero Docker container conflicts  
- ✅ All HTML/CSS/JS paths functional after migration
- ✅ Development files separated from application code
