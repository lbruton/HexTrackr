...
HexTrackr uses a persistent AI memory system to maintain context across sessions and ensure project continuity. This document outlines the mandatory memory practices for all developers.
