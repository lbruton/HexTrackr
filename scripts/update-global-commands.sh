...
echo ""
echo "Commands updated for:"
echo "  - New spec-kit constitutional structure"
echo "  - PROJECT:DOMAIN:TYPE classification"
echo "  - Semantic search mode enforcement"
echo "  - Article VI compliance (save to Memento)"
echo ""