...
**Parent Issue**: [HEX-YYY](https://linear.app/hextrackr/issue/HEX-YYY)
**Phase**: Implementation - [Backend/Frontend/Testing/Docs]
**Status**: In Progress
**Started**: YYYY-MM-DD
...
- **Brainstorm**: `/docs/brainstorming/BRAINSTORM-[feature-name].md`
- **Specification**: Linear HEX-XXX (SPECIFICATION issue)
- **Research**: Linear HEX-XXX (RESEARCH issue)
- **Plan**: Linear HEX-XXX (PLAN issue)
- **Related Issues**: HEX-XXX, HEX-XXX

---

## Objective

[Brief description of what this implementation phase accomplishes]
