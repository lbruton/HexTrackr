...
const sortColumn = 0; // Default to date column (index 0) - most recent first
const sortDirection = "desc"; // 'asc' or 'desc' - default to descending for recent dates first
...
const notesIndex = null;
/** @type {number|null} Change log entry currently being edited */
const editingChangeLogIndex = null;

/** @type {Object} Pagination state */
const currentPage = 1; // Current page number (1-based)
const itemsPerPage = 10; // Number of items to display per page (default changed to 10+)
...
const compositionOptions = new Set(["Gold", "Silver", "Platinum", "Palladium", "Alloy"]);

/** @type {Set<number>} Items currently showing market value instead of purchase price */
const marketValueViewItems = new Set();
