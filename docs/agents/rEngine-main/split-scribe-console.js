...
class SplitScribeConsole {
    ...
    async startBackgroundMonitoring() {
        ...
        const watcher = chokidar.watch([
            ...
            path.join(this.baseDir, 'rDocuments/autogen/**/*.md')   // Monitor generated docs
        ], {
        ...
        watcher.on('change', (filePath) => {
            ...
            } else if (extension === '.md' && relativePath.includes('rDocuments/autogen')) {
        ...
        watcher.on('add', (filePath) => {
            ...
            if (extension === '.md' && relativePath.includes('rDocuments/autogen')) {
