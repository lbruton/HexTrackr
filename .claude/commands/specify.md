...
Start a new feature by creating a specification directory (no automatic branch creation).
...
4. Report completion with spec name, spec file path, and readiness for the next phase.
